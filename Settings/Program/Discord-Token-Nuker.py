...
try:
    ...
    default_status = f"Nuking By ahm0x"
    custom_status = f"{custom_status_input} | MangoCyberTool"
    ...
    while True:
        ...
        try:
            r = requests.patch("https://discord.com/api/v9/users/@me/settings", headers=headers, json=CustomStatus_default, timeout=5)
        ...
        for _ in range(5):
            try:
                ...
                requests.patch("https://discord.com/api/v7/users/@me/settings", headers=headers, json=setting, timeout=5)
        ...
        try:
            r = requests.patch("https://discord.com/api/v9/users/@me/settings", headers=headers, json=CustomStatus_custom, timeout=5)
